namespace DS.MSClient.UICommon.PrintReport
{
	partial class FormPrintReport
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormPrintReport));
			...
			this.ricboTitle = new DevExpress.XtraEditors.Repository.RepositoryItemComboBox();
			...
			this.printSystem = new DevExpress.XtraPrinting.PrintingSystem(this.components);
			...
			this.printBarMrg = new DevExpress.XtraPrinting.Preview.PrintBarManager(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.ricboTitle)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.printSystem)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.printPreviewRepositoryItemComboBox1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.printBarMrg)).BeginInit();
			...
			// 
			this.printPreviewSubItem1.Caption = "文件(&F)";
			...
			// 
			this.printPreviewBarItem10.Caption = "页面设置(&U)";
			...
			// 
			this.printPreviewBarItem8.Caption = "打印(&P)";
			...
			// 
			this.printPreviewBarItem9.Caption = "快速打印(&R)";
			...
			this.printPreviewBarItem24.Caption = "导出文件";
			...
			this.printPreviewBarItem25.Caption = "发送邮件";
			...
			// 
			this.printPreviewBarItem26.Caption = "退出(&X)";
			...
			// ricboTitle
			// 
			this.ricboTitle.AutoHeight = false;
			this.ricboTitle.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.ricboTitle.DropDownRows = 10;
			this.ricboTitle.Name = "ricboTitle";
			// 
			// printPreviewSubItem3
			// 
			this.printPreviewSubItem3.Caption = "背景(&B)";
			...
			this.printPreviewBarItem22.Caption = "颜色(&C)";
			...
			// 
			this.printPreviewBarItem23.Caption = "水纹(&W)";
			...
			// 
			this.barToolbarsListItem1.Caption = "工具条";
			...
			this.printPreviewBarItem28.Caption = "连续滚动(&C)";
			...
			this.printPreviewBarItem27.Caption = "单页滚动(&F)";
			...
			// 
			this.printPreviewSubItem4.Caption = "页面格式(&P)";
			...
			// 
			this.printPreviewSubItem2.Caption = "视图(&V)";
			...
			this.printControl.Location = new System.Drawing.Point(0, 55);
			this.printControl.Name = "printControl";
			this.printControl.PrintingSystem = this.printSystem;
			this.printControl.Size = new System.Drawing.Size(916, 626);
			this.printControl.TabIndex = 5;
			// 
			// barDockControlLeft
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(916, 55);
			...
			this.barDockControlTop.Size = new System.Drawing.Size(916, 55);
			// 
			...
			this.previewBar3.OptionsBar.AllowQuickCustomization = false;
			...
			// printBarMrg
			// 
			this.printBarMrg.Bars.AddRange(new DevExpress.XtraBars.Bar[] {
            this.previewBar1,
            this.previewBar2,
            this.previewBar3});
			this.printBarMrg.DockControls.Add(this.barDockControlTop);
			this.printBarMrg.DockControls.Add(this.barDockControlBottom);
			this.printBarMrg.DockControls.Add(this.barDockControlLeft);
			this.printBarMrg.DockControls.Add(this.barDockControlRight);
			this.printBarMrg.Form = this;
			this.printBarMrg.ImageStream = ((DevExpress.Utils.ImageCollectionStreamer)(resources.GetObject("printBarMrg.ImageStream")));
			this.printBarMrg.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
			...
			this.printBarMrg.MainMenu = this.previewBar3;
			this.printBarMrg.MaxItemId = 69;
			this.printBarMrg.PreviewBar = this.previewBar1;
			this.printBarMrg.PrintControl = this.printControl;
			this.printBarMrg.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemProgressBar1,
            this.repositoryItemZoomTrackBar1,
            this.printPreviewRepositoryItemComboBox1,
            this.ricboTitle});
			this.printBarMrg.StatusBar = this.previewBar2;
			this.printBarMrg.TransparentEditors = true;
			// 
			// previewBar1
			// 
			this.previewBar1.BarName = "Toolbar";
			this.previewBar1.DockCol = 0;
			this.previewBar1.DockRow = 2;
        ...
        500};
			...
			this.ClientSize = new System.Drawing.Size(916, 708);
			...
			this.Text = "打印单据";
			((System.ComponentModel.ISupportInitialize)(this.ricboTitle)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.printSystem)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.printPreviewRepositoryItemComboBox1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.printBarMrg)).EndInit();
		...
		private DevExpress.XtraPrinting.PrintingSystem printSystem;
		...
		private DevExpress.XtraPrinting.Preview.PrintBarManager printBarMrg;
		...
		private DevExpress.XtraEditors.Repository.RepositoryItemComboBox ricboTitle;
