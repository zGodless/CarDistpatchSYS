...
{
    [ToolboxItem(true)]
    public class CLookSeachSchool : CSmartLookUpEditBase
    {
        ...
        ///     绑定下拉控件数据集
        /// </summary>
        public void BindList(int TrainPlaceID = 0, bool getFromCache = false)
        {
            if (getFromCache)
            {
        ...
        ///     绑定下拉控件数据集
        /// </summary>
        public void BindListAll(bool getFromCache = false)
        {
            if (getFromCache)
            {
