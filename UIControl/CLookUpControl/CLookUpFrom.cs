...
{
    [ToolboxItem(true)]
    public class CLookUpFrom : CSmartLookUpEditBase
    {
        protected override void OnCreateControl()
        {
            ...
            if (Properties.Columns.Count == 0)
            {
				...
				{
					new LookUpColumnInfo("FromCode", "来源编号"),
					new LookUpColumnInfo("FromName", "名称"),
                    new LookUpColumnInfo("ParentFromName", "上级来源"),
        ...
        public List<From> ListIsValid { get; set; }
        public From CurrentFrom { get; set; }
        ...
        private void cLookUp_EditValueChanged(object sender, EventArgs e)
        {
            ...
            CurrentFrom = EditValue == null
                   ? null
                   : ListIsValid.Find(model => model.FromID == Convert.ToInt32(EditValue));
        }
